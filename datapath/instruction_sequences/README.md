...
For testing and simulation, the memory module in a ```full_dp_instr_seq*.v``` file should  be replaced with a memory module with desired instructions and data hardcoded.
